...
<Card   style={{ width: '10rem'}}>
      <Card.Img style={{height:"120px"}} variant="top"  src="https://teachers-crew.web.app/images/achi%20wali.jpg" />
      <Card.Body>
...
<Card   style={{ width: '10rem'}}>
    ...
    //  <Card className="col-lg-2 col-md-3 col-sm-4 col-xs-6"  style={{ width: '10rem',background:"white", color:"black",marginTop:"10px",display:"flex",justifyContent:"center" }}>
